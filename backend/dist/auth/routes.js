...
router.put('/password', middleware_1.requireAuth, profile_1.updatePasswordValidation, middleware_2.handleValidationErrors, auth_1.AuthController.updatePassword);
router.post('/forgot-password', profile_1.forgotPasswordValidation, middleware_2.handleValidationErrors, auth_1.AuthController.forgotPassword);
router.post('/reset-password', profile_1.resetPasswordValidation, middleware_2.handleValidationErrors, auth_1.AuthController.resetPassword);
