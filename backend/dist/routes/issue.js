...
router.post('/:id/assign', issueValidation.getIssueValidation, issueController.assignIssue);
// POST /api/issues/:id/unassign - Unassign issue
router.post('/:id/unassign', issueValidation.getIssueValidation, issueController.unassignIssue);
